...
\title[Stochastic Calculus Foundations]{Overview of Stochastic Calculus Foundations} % The short title appears at the bottom of every slide, the full title is only on the title page
