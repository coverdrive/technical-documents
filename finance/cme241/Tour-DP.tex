...
\item Generalized Policy Iteration: Powerful idea of alternating between improvement of a policy and evaluation of a value function, even though each of them might be partial applications. This generalized perspective unifies almost all algorithms for MDP Control.
