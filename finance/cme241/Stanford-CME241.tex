...
\date{Winter 2023} % Date, can be changed to a custom date
...
\begin{frame}
	...
	\begin{itemize}[<+->]
		\item Grade based on:
		\begin{itemize}
			\item 40\% {\em Exam} (1.5 hour exam on Theory, Modeling, Programming)
		...
		\item Assignments
		\begin{itemize}
			\item Can be completed in groups of up to 3
		...
		\item Project
		\begin{itemize}
			\item Open-ended research or implementation project
			\item Choose topics of interest, a list of ideas will be released by Week 5
			\item Deliverables will be a presentation and code turn-in
		\end{itemize}
	\end{itemize}
\end{frame}
