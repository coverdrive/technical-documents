...
\date{Winter 2020} % Date, can be changed to a custom date
...
\end{itemize}
\item Register for the \href{https://piazza.com/stanford/winter2020/cme241/home}{\underline{\textcolor{blue}{course on Piazza}}}
...
\item Message me on Piazza with your git repo URL (for reviews/grading)
...
\item These algorithms are often refered to as {\em Planning Algorithms}
...
\item RL interacts with {\em Actual Environment} or with {\em Environment Simulator}
