...
\title[``RL for Finance'' course]{CME 241: Reinforcement Learning for \\ Stochastic Control Problems in Finance} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\date{Winter 2021} % Date, can be changed to a custom date
...
\pause
\begin{itemize}[<+->]
\item Joined Stanford ICME as Adjunct Faculty in Fall 2018
...
\item Current Industry Job: V.P. of A.I. at Target (the Retail company)
\end{itemize}
\end{frame}
...
\end{itemize}
\item Register for the \href{https://piazza.com/stanford/winter2021/cme241/home}{\underline{\textcolor{blue}{course on Piazza}}}
...
\item Course Assistant (CA) is Sven Lerner (\href{mailto:svenl@stanford.edu}{\underline{\textcolor{blue}{svenl@stanford.edu}}})
\item Send Sven (on Piazza) your git repo URL (for reviews/grading)
\end{itemize}
\end{frame}
...
\end{itemize}
\item Lectures (on Zoom): Wed \& Fri 4:00pm - 5:20pm, Jan 13  - Mar 19
\item Office Hours 1-4pm Fri (or by appointment) on Zoom
\item Course Web Site: \href{http://cme241.stanford.edu}{\underline{\textcolor{blue}{cme241.stanford.edu}}}
\item Ask Questions and engage in Discussions on \href{https://piazza.com/stanford/winter2021/cme241/home}{\underline{\textcolor{blue}{Piazza}}}
...
\item Sven will review once every 3 weeks and provide feedback
...
\pause
\begin{itemize}[<+->]
\item Course based on the (incomplete) \href{http://stanford.edu/~ashlearn/RLForFinanceBook/book.pdf}{\underline{\textcolor{blue}{book}}} I am currently writing
...
\item Assignments and code in my book based on \href{https://github.com/TikhonJelvis/RL-Book}{\underline{\textcolor{blue}{this open-source code}}}
\item Clone this repo and \href{http://web.stanford.edu/class/cme241/lecture_slides/assignments/assignment1.pdf}{\underline{\textcolor{blue}{get set up}}} to use this code in assignments
...
\item All of this will be organized on the \href{http://cme241.stanford.edu}{\underline{\textcolor{blue}{course web site}}} (``source of truth'')
\end{itemize}
\end{frame}
...
\item This amounts to specifying a Utility function
...
\item W9: Policy Gradient and Actor-Critic Algorithms
\item W10: Model-based RL and Explore v/s Exploit
\item Final Exam
\end{itemize}
\end{frame}
