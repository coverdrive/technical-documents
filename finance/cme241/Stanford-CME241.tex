...
\end{itemize}
\item Here's \href{http://web.stanford.edu/class/cme241/lecture_slides/final-2020.pdf}{\underline{\textcolor{blue}{last year's final exam}}}  to get a sense of course difficulty
...
\item Transitions $p(s',r|s,a) = \mathbb{P}[S_{t+1}=s',R_{t+1}=r|S_t=s,A_t=a]$
