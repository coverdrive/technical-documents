...
\item {\em State} is [Current Time, History of Spot Prices]
\item {\em Action} is Boolean: Exercise (i.e., Payoff and Stop) or Continue
\item {\em Reward} always 0, except upon Exercise ($=$ Payoff)
\item {\em State}-transitions governed by Spot Price Stochastic Process
...
\begin{frame}
\frametitle{Sneak Peek into a couple of lectures in this course}
\begin{itemize}
\item \href{https://www.slideshare.net/cover_drive/policy-gradient-theorem}{\underline{\textcolor{blue}{Policy Gradient Theorem and Compatible Approximation Theorem}}}
\item \href{https://www.slideshare.net/cover_drive/hjb-equation-and-mertons-portfolio-problem}{\underline{\textcolor{blue}{HJB Equation and Merton's Portfolio Problem}}}
\end{itemize}
\end{frame}
...
\item \href{http://incompleteideas.net/Talks/gradient-TD-2011.pdf}{\underline{\textcolor{blue}{Gradient TD Learning Algorithms}}}
\end{itemize}
\end{frame}
