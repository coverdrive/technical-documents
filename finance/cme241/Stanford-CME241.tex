...
\item Grade based on:
\begin{itemize}
\item 40\% {\em Exam} (48-hour Open-Internet: Theory, Modeling, Programming)
...
\item Office Hours 1:00pm-2:30pm Fri (or by appointment) in ICME Mezzanine level, room M05 (within Huang Engg Bldg)
