...
\date{Winter 2025} % Date, can be changed to a custom date
...
\item Currently Chief AI Officer at QXO (distribution of building materials)
...
\item Register for the \href{https://edstem.org/us/courses/70339}{\underline{\textcolor{blue}{course on Ed Discussion}}}
...
\item {\em Fork} this repo and get set up to use this code in assignments (Assignment 0)
\item Create separate directories for each assignment for CA \href{mailto:neelsn@stanford.edu}{\underline{\textcolor{blue}{Neel Narayan}}} to review - send Neel your forked repo URL and {\em git push} by due dates
\end{itemize}
\end{frame}
...
\pause
\begin{itemize}[<+->]
\item Lectures: Wed \& Fri 4:30pm-5:50pm in 160-124.
\item Office Hours:
\begin{enumerate}
	\item  Ashwin: 2:30pm-4:00pm Fri (or by appointment) in ICME Mezzanine, room M05 (within Huang Engg Bldg)
	\item  Neel: poll will be sent out on Ed (or by appointment)
\end{enumerate}
\item Course Web Site: \href{http://cme241.stanford.edu}{\underline{\textcolor{blue}{cme241.stanford.edu}}}
\item Ask Questions and engage in Discussions on \href{https://edstem.org/us/courses/70339}{\underline{\textcolor{blue}{Ed Discussion}}}
\item Note: This course is listed as CME 241 as well as MS\&E 346
\item Any accommodations: Please reach out to me or Neel as soon as possible
\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}[<+->]
		...
		\begin{itemize}
			...
			\item 30\% {\em Exam} (Theory, Modeling, and Programming)
			\item 20\% {\em Project} (Idea Creativity, Proof-of-Concept, Presentation)
		...
		\item Exam
		\begin{itemize}
		\item Individual take-home exam in week 8, covering topics from weeks 1-7
		\item 48 hour window (tentatively 8PM 2/28 to 8 PM 3/2) 
...
\begin{frame}
\frametitle{Stanford Honor Code - Assignments versus Exams}
\pause
\begin{itemize}[<+->]
\item {\em Assignments}: You can discuss approaches among your group members, not with other students outside of your group
\begin{itemize}
\item Each group member should be responsible for a subset of questions (indicate which question you do on the assignment)
\item Writing answers/code should be your own (don't copy/paste)
\item You can invoke the core modules we have written (as instructed), and can use LLMS (ChatGPT for example)
\end{itemize}
...
\item Open-internet Exams: Search for concepts, not answers to exam questions
