...
\item Pricing of $D'$ is based on the principle that introducing the incremental position of $D'$ together with a calibrated cashflow at $t=0$ should leave the Optimal Value (at $t=0$) unchanged
