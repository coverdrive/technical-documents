...
\begin{document}
\begin{center}
{\large {\bf Stanford CME 241 Winter 2026 - Assignment 0 \\ due Sunday, January 11th @ 11:59 PM}}
\end{center}

\begin{questions}
\question Make sure you have access to the course Canvas and Ed Discussion pages \\ (email \href{mailto:cyc2152@stanford.edu}{\underline{\textcolor{blue}{Catherine Chen}}} if you do not)
...
\question Create clearly-named directories for assignments and the course project for the Course Assistant (\href{mailto:cyc2152@stanford.edu}{\underline{\textcolor{blue}{Catherine Chen}}}) to review and grade - each team of up to 3 (who submits together) should send Catherine their forked repo URL and {\em git push} their work by the due dates (to their forked repo).\footnote{We expect teams formed for assignments to remain consistent throughout the quarter. If issues arise, let us know.}
