...
\begin{questions}
\question Make sure you have access to the course Canvas and Ed Discussion pages \\ (email \href{mailto:amil@stanford.edu}{\underline{\textcolor{blue}{Amil}}} if you do not)
...
\question Create clearly-named directories for assignments and the course project for the Course Assistant (\href{mailto:amil@stanford.edu}{\underline{\textcolor{blue}{Amil}}}) to review and grade - each team of up to 3 (who submits together) should send Amil their forked repo URL and {\em git push} their work by the due dates (to their forked repo).\footnote{We expect teams formed for assignments to remain consistent throughout the quarter. If issues arise, let us know.}
